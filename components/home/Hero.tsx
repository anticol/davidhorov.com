...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm David.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I enjoy <span className="heroShiny1 text-fun-pink">coding</span> {" "}
          web apps and doing{' '}<span className="heroShiny1 text-fun-pink">frontend</span>.
          {/* <img
